  ...
  (function() {
    ...
    function initAdvancedReviews(block) {
      ...
      function loadDistribution() {
        ...
        fetch(url.toString(), { cache: "no-cache" }).then(function(res) {
          return res.json();
        }).then(function(data) {
          if (distributionArea) {
      ...
      function fetchReviews() {
        ...
        return fetch(url.toString(), { cache: "no-cache" }).then(function(res) {
          return res.json();
        }).catch(function() {
          return null;
        });
        ...
        if (result.success) {
          ...
          setTimeout(function() {
            ...
            if (productId2) {
              ...
              fetch(distUrl.toString(), { cache: "no-cache" }).then(function(res) {
                return res.json();
              }).then(function(data2) {
